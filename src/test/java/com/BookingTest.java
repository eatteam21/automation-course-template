...
public class BookingTest extends BasicTest {
    ...
    public void loginTestSuccess(String uname, String pw, boolean expectedLogoutDisplay) throws Exception {
        ...
        // ProductDetailsPage
        // productDetailsPage.selectOption("Bơm nước xe");
        // productDetailsPage.selectXuatXuGermany();
        // productDetailsPage.clickSoLuong();
        // productDetailsPage.clickAdd();
        // chọn option 1
